...
public class HermitMod implements
    ...
    public static void initialize() {
        ...
        System.out.println("========================= Initializing Default Mod. Hi. =========================");
        HermitMod hermitMod = new HermitMod();
        System.out.println("========================= /Default Mod Initialized. Hello World./ =========================");
        try {
    ...
    public void receivePostInitialize() {
        ...
        ModLabel modLabel = new ModLabel("Yep, that's a mod.", 400, 700, settingsPanel, (panel) -> {});

        settingsPanel.addUIElement(modLabel);
    ...
    public void receiveEditRelics() {
        ...
        UnlockTracker.markRelicAsSeen(BloodyTooth.ID);
        UnlockTracker.markRelicAsSeen(BrassTacks.ID);
        UnlockTracker.markRelicAsSeen(Spyglass.ID);
        UnlockTracker.markRelicAsSeen(StraightRazor.ID);
        UnlockTracker.markRelicAsSeen(CharredGlove.ID);
        UnlockTracker.markRelicAsSeen(BlackPowder.ID);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("Hermit")
                .packageFilter(AbstractHermitCard.class)
                .setDefaultSeen(true)
                .cards();
